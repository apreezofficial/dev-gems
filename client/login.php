  ...
  <div class="max-w-5xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-2xl shadow-lg overflow-hidden">
    ...
    <div class="p-8 sm:p-12 flex flex-col justify-center animate-fadeIn">
      <div class="max-w-sm mx-auto w-full">
        ...
        <h2 class="text-2xl sm:text-3xl font-bold text-black dark:text-white mb-2">Welcome Back</h2>
        <p class="text-gray-600 dark:text-gray-400 mb-8">Log in to start connecting instantly.</p>
        <form id="login-form" class="space-y-6">
          ...
          <button type="submit" class="w-full px-4 py-3 bg-black dark:bg-white text-white dark:text-black rounded-lg font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-all duration-300 hover:scale-105">Log In</button>
        </form>
        <p id="error-message" class="mt-4 text-center text-sm text-red-500 hidden"></p>
        <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          Don’t have an account? <a href="signup.php" class="text-black dark:text-white hover:underline font-medium">Sign up</a>
        </p>
      </div>
    </div>
    ...
    <div class="hidden md:block relative bg-gray-100 dark:bg-gray-800 p-12">
      ...
      <div class="relative z-10 flex flex-col justify-center h-full animate-fadeIn delay-200">
        <h3 class="text-xl font-bold text-black dark:text-white mb-4">Connect Seamlessly</h3>
        <p class="text-gray-600 dark:text-gray-400">Join meetings with crystal-clear video and secure connections, anywhere, anytime.</p>
      </div>
    </div>
